...
from models.speech_transformer.attention import MultiHeadAttention
from models.speech_transformer.module import PositionalEncoding, PositionwiseFeedForward
from tools.mask import (get_attn_key_pad_mask, get_attn_pad_mask,
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        print('tgt_vocab: ',n_tgt_vocab, d_word_vec)
    ...
    def forward(self, padded_input, encoder_padded_outputs,
        ...
        # Forward
        ys_in_pad = ys_in_pad.type(torch.LongTensor).to('cuda')
        # print(self.tgt_word_emb(ys_in_pad))
        # print(self.positional_encoding(ys_in_pad))
