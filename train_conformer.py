...
from models.conformer.decoder import LSTMDecoder
from models.conformer.optimizer import *
from utils import *
from tools.ctc_decoder import *
...
parser.add_argument('--checkpoint_path', type=str, default='ckpts/conformer_best.pt', help='path to store/load checkpoints')
parser.add_argument('--load_checkpoint', action='store_true', default=True, help='resume training from checkpoint')
...
parser.add_argument('--model_path', type=str, default='saved_models', help='path to save the models')
parser.add_argument('--use_amp', action='store_true', default=False, help='use mixed precision to train')
parser.add_argument('--attention_heads', type=int, default=4, help='number of heads to use for multi-head attention.py')
...
parser.add_argument('--dropout', type=float, default=.1, help='dropout factor for conformer models')
parser.add_argument('--weight_decay', type=float, default=1e-6, help='models weight decay (corresponds to L2 regularization)')
parser.add_argument('--variational_noise_std', type=float, default=.0001, help='std of noise added to models weights for regularization')
